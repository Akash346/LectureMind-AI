...
export default function AdministrationStartPage() {
  return (
    <PageShell>
        ...
        >
          <GlassPanel className="p-8 sm:p-10">
            <h1 className="font-space-grotesk text-3xl font-semibold">
              Administration experience is coming soon.
            </h1>
            <p className="mt-4 leading-7 text-black/70 dark:text-white/70">
              LectureMind will help academic teams understand lecture quality,
              accessibility patterns, and learning support needs across
              programs.
            </p>
            <form
